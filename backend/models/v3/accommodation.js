...
const accommodationSchema = new mongoose.Schema(
  {
    ...
    address: {
      type: String,
      required: [true, 'Accommodation address is required'],
    },
    type: {
      type: String,
      validate: {
    ...
    min_price: {
      ...
      validate: {
        ...
        message:
          'Accommodation minimum price should be a number greater than or equal to 0',
      },
    ...
    max_price: {
      ...
      validate: {
        ...
        message:
          'Accommodation maximum price should be a number greater than or equal to accommodation minimum price',
      },
    ...
    size_sqm: {
      ...
      validate: {
        ...
        message:
          'Accommodation size in square meter should be a number greater than 0',
      },
    ...
    meters_from_uplb: {
      ...
      validate: {
        ...
        message:
          'Accommodation distance from UPLB should be a number greater than or equal to 0',
      },
    ...
    min_pax: {
      ...
      validate: {
        ...
        message:
          'Accommodation minimum pax allowed should be a number greater than 0',
      },
    ...
    max_pax: {
      ...
      validate: {
        ...
        message:
          'Accommodation maximum pax allowed should be a number greater than the minimum number of pax allowed',
      },
    ...
    num_rooms: {
      ...
      validate: {
        ...
        message:
          'Accommodation minimum number of rooms should be greater than 0',
      },
      required: true,
    },
    num_beds: {
    ...
    num_views: {
      ...
      validate: {
        ...
        message:
          'Minimum number of views allowed should be greater than or equal to 0',
      },
      required: true,
    },
