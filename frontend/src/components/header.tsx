...
function Header() {
  ...
  const MenuAccommList = tabs.map(tab => (
    <MenuItem onClick={() => navigate('/')} sx={{ fontFamily: sourceSansPro }}>
      {tab}
    </MenuItem>
  ))
        ...
        <Toolbar>
          {isNonMobileDevice ? (
            ...
            <>
              ...
              <Menu
                aria-labelledby="Header-Accomm-Menu-Btn"
                open={open}
                onClose={handleClose}
              ...
              <Menu
                aria-labelledby="Header-Account-Menu-Btn"
                open={openAcc}
